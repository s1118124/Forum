...
<html>
    ...
    <body>
        ...
        <security:authorize access="hasAnyRole('ADMIN','USER')">
            <a href="<c:url value="/lecture/create" />">Create a Topic</a><br /><br />
        </security:authorize>
        <c:choose>
            ...
            <c:otherwise>
                <c:forEach items="${topicDatabase}" var="entry">
                    ...
                    <security:authorize access="hasRole('ADMIN')">  
                        [<a href="<c:url value="/lecture/edit/${entry.key}" />">Edit</a>]
                        [<a href="<c:url value="/lecture/delete/${entry.key}" />">Delete</a>]
                    </security:authorize>
                    <br />
                </c:forEach>
            </c:otherwise>
