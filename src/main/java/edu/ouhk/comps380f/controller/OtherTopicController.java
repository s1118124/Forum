...
public class OtherTopicController {
    ...
    public ModelAndView view(@PathVariable("topicId") long topicId) {
        ...
        if (topic == null) {
            return new ModelAndView(new RedirectView("/other/list", true));
        }
        ModelAndView modelAndView = new ModelAndView("otherTopicView");
    ...
    public ModelAndView create() {
        return new ModelAndView("addToOther", "topicForm", new Form());
    }
    ...
    public View create(Form form, Principal principal) throws IOException {
        ...
        return new RedirectView("/other/view/" + topic.getId(), true);
    }
    ...
    public View download(@PathVariable("topicId") long topicId,
        ...
        return new RedirectView("/other/list", true);
    }
    ...
    public View deleteAttachment(@PathVariable("topicId") long topicId,
        ...
        return new RedirectView("/other/edit/" + topicId, true);
    }
    ...
    public ModelAndView showEdit(@PathVariable("topicId") long topicId) {
        ...
        ModelAndView modelAndView = new ModelAndView("editOtherTopic");
        modelAndView.addObject("topicId", Long.toString(topicId));
        modelAndView.addObject("topic", topic);
