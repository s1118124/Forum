...
@Controller
@RequestMapping("lab")
public class LabTopicController {
    ...
    public ModelAndView view(@PathVariable("topicId") long topicId) {
        ...
        if (topic == null) {
            return new ModelAndView(new RedirectView("/lab/list", true));
        }
        ModelAndView modelAndView = new ModelAndView("labTopicView");
    ...
    public ModelAndView create() {
        return new ModelAndView("addToLab", "topicForm", new Form());
    }
    ...
    public View create(Form form, Principal principal) throws IOException {
        ...
        return new RedirectView("/lab/view/" + topic.getId(), true);
    }
    ...
    public View download(@PathVariable("topicId") long topicId,
        ...
        return new RedirectView("/lab/list", true);
    }
    ...
    public View deleteAttachment(@PathVariable("topicId") long topicId,
        ...
        return new RedirectView("/lab/edit/" + topicId, true);
    }
    ...
    public ModelAndView showEdit(@PathVariable("topicId") long topicId) {
        ...
        ModelAndView modelAndView = new ModelAndView("editLabTopic");
        modelAndView.addObject("topicId", Long.toString(topicId));
        modelAndView.addObject("topic", topic);
